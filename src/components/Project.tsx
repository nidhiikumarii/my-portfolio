...
continuous engagements.</p>
            ...
            <div className="project">
                <a href="https://yujisatojr.itch.io/spacecraft" target="_blank" rel="noreferrer"><img src={yt} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://yujisatojr.itch.io/spacecraft" target="_blank" rel="noreferrer"><h2>YT Shorts - Problem framing and Prioritisation</h2></a>
            ...
            <div className="project">
                <a href="https://www.datumlearn.com/" target="_blank" rel="noreferrer"><img src={ap} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://www.datumlearn.com/" target="_blank" rel="noreferrer"><h2>Analytics and Metrics - Amazon Prime</h2></a>
            ...
            <div className="project">
                <a href="http://www.wemanage.jp/" target="_blank" rel="noreferrer"><img src={ytm} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="http://www.wemanage.jp/" target="_blank" rel="noreferrer"><h2>Analytics and Metrics - Youtube Music</h2></a>
            ...
            <div className="project">
                <a href="https://www.byuh.edu/covid-19-case-management" target="_blank" rel="noreferrer"><img src={zepto} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://www.byuh.edu/covid-19-case-management" target="_blank" rel="noreferrer"><h2>Analytics and Metrics - Zepto</h2></a>
        ...
        <div className="cert-grid">
            <div className="cert">
                <a href="https://github.com/nidhiikumarii/github.io/blob/main/Rapido.pdf" target="_blank" rel="noreferrer"><img src={airtribe} className="zoom" alt="thumbnail" width="50%"/></a>
                <a href="https://github.com/nidhiikumarii/github.io/blob/main/Rapido.pdf/" target="_blank" rel="noreferrer"><h2>Airtribe</h2></a>
            ...
            <div className="cert">
                <a href="https://github.com/nidhiikumarii/github.io/blob/main/Fitness%20App.pdf" target="_blank" rel="noreferrer"><img src={ga} className="zoom" alt="thumbnail" width="50%"/></a>
                <a href="https://github.com/nidhiikumarii/github.io/blob/main/Fitness%20App.pdf" target="_blank" rel="noreferrer"><h2>Google Analytics</h2></a>
            ...
            <div className="cert">
                <a href="https://yujisatojr.itch.io/spacecraft" target="_blank" rel="noreferrer"><img src={uiux} className="zoom" alt="thumbnail" width="50%"/></a>
                <a href="https://yujisatojr.itch.io/spacecraft" target="_blank" rel="noreferrer"><h2>UI UX</h2></a>
            ...
            <div className="cert">
                <a href="https://www.datumlearn.com/" target="_blank" rel="noreferrer"><img src={sql} className="zoom" alt="thumbnail" width="50%"/></a>
                <a href="https://www.datumlearn.com/" target="_blank" rel="noreferrer"><h2>SQL</h2></a>
